...
- Set up Teleport through one of our [getting started guides](https://goteleport.com/docs/getting-started/linux-server/). You can also begin a [free trial](https://goteleport.com/signup/) of Teleport Cloud.
