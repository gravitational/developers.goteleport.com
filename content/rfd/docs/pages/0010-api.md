---
title: RFD 10 - API and Client Libraries
description: Unify Golang Client experience. Automatically generate API documentation using pkg.go.dev.
h1: RFD 10 - API and Client Libraries
