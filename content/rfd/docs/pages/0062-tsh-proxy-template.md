---
title: RFD 62 - Proxy template support for tsh proxy
description: RFD 62 proposes the UX for better `tsh proxy` command interoperability with `ssh` client and connecting to leaf cluster proxies directly.
h1: RFD 62 - Proxy template support for tsh proxy
