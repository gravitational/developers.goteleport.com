---
title: RFD 59 - Search Based Access Requests
description: This RFD proposes just-in-time search-based access requests which will enable users to request access to resources based on a search and/or selection of individual resources, rather than having to request one or more roles.
h1: RFD 59 - Search Based Access Requests
authors: Alexander Klizhentas (sasha@goteleport.com), Nic Klaassen (nic@goteleport.com)
state: draft
---

This RFD also proposes a method to automatically request access to an SSH node during
