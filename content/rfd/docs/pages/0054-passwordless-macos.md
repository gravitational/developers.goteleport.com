---
title: "RFD 54 - Passwordless for macOS CLI"
description: Passwordless features for native macOS CLIs, aka Touch ID support for CLI `tsh`.
h1: "RFD 54 - Passwordless for macOS CLI"
